...
# --- AI Code Playground (removed) ---
st.markdown("""
<h3 style="color:#ffa500; margin-top:2rem;">AI Code Playground — Removed</h3>
<p style="color:#ffd700;">The AI Code Playground has been removed from this instance. If you need the feature restored, please contact the maintainer or check the project history for the previous implementation.</p>
""", unsafe_allow_html=True)
